...
risk_prompt = ChatPromptTemplate.from_messages([
    ...
    ("human",
     ...
     "   - CRITICAL RULE: If the guideline states a condition is a **Contraindication**, you MUST assign 'High' risk.\n"
     "   - If the guideline states a **Warning** or **Precaution** or suggests dose limits that are exceeded, assign 'Moderate' risk.\n"
     "   - If the medication is generally safe or no specific risks are found, assign 'Low' risk.\n"
     "6. Cite the specific guideline source and page number for every claim. The 'page' MUST be an integer (e.g., 5). If no page is provided, output 0. Do NOT output strings like 'High'.\n\n"
     "Patient Context:\n{patient_context}\n\n"
     "Proposed Medication:\n{medication_context}\n\n"
     "Guideline Excerpts:\n{guideline_text}\n\n"
     "Output Format:\n{format_instructions}")
